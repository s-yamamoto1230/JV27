...
public class class_update_OP extends HttpServlet{
     ...
     throws ServletException,IOException{
          ...
          String syusseki_no,gakuseki_no,simei_1,simei_2,kana_1,kana_2,umare;
          PrintWriter out;
          ...
          sb.append("<html>");
          sb.append("<head><title>更新対象選択</title></head>");
          sb.append("<body bgcolor='#fff'>");
          sb.append("    class_update.java");
          sb.append("    <center>");
          sb.append("         <caption><font size='+3' color='#0000ff'><B>＜＜更新選択＞＞</B></font></caption>");
          sb.append("         <br><br><br>");
          sb.append("         <font size='+2' color='deeppink'>");
          sb.append(               class_noStr);
          sb.append("         </font>");
          sb.append("         <br><br>");
          sb.append("         <form method='post' action='./class_update2_OP'>");
          sb.append("              <table border='1' bordercolor='darkblue'>");
          sb.append("                   <tr>");
          sb.append("                        <td bgcolor='darkblue'>");
          sb.append("                             <font color='white'>更新</font>");
          sb.append("                        </td>");
          sb.append("                        <td bgcolor='darkblue'>");
          ...
          sb.append("                             <input type='radio' name='update_data' value='");
          ...
          sb.append("    <hr><a href='../class_update_OP.html'>選択に戻る</a>");
