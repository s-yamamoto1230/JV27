...
<html>
    ...
    <body bgcolor="#ffffff">
        ...
        <center>
            ...
            <br>
            <form name="frm" action="./class_update3" method="post">
                ...
                <table border=0>
                    ...
                    <tr>
                        <td>出席番号</td>
                        <td>
                            <input type="text" name="syusseki_no" size=20 value="<%= request.getAttribute("syusseki_no").toString() %>">
                        </td>
                    </tr>
                    <tr>
                        <td>氏名（姓）</td>
        ...
        <script>
            switch ("<%= request.getAttribute("class_no").toString() %>"){
             ...
             document.frm.class_no.selectedIndex = class_no;
